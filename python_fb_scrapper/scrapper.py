...
class FacebookPostScraper:
    """
    FacebookPostScraper class for scraping Facebook posts using Selenium and BeautifulSoup.
    """
    ...
    def login(self, username, password) -> None:
        ...
        Args:
            username (`str`): Facebook account username/email.
...
if __name__ == "__main__":
    posts_url = input("Enter the URL of Facebook posts: ")
    scraper = FacebookPostScraper(posts_url)
    ...
    print(len(profile_names_list), len(descriptions_list), len(profile_urls_list), len(comments_list),
          len(who_commented_list))
